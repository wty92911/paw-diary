...
export const SUPPORTED_IMAGE_FORMATS = ['image/jpeg', 'image/jpg', 'image/png', 'image/webp', 'image/bmp']
...
export const COMMON_CAT_BREEDS = [
  ...
  'Abyssinian', 'Scottish Fold', 'Sphynx', 'Russian Blue', 'Bengal',
  'American Shorthair', 'Oriental', 'Mixed Breed'
]

export const COMMON_DOG_BREEDS = [
  'Labrador Retriever', 'Golden Retriever', 'German Shepherd', 'Bulldog',
  'Poodle', 'Beagle', 'Rottweiler', 'Yorkshire Terrier', 'Boxer',
  'Siberian Husky', 'Border Collie', 'Chihuahua', 'Mixed Breed'
]

// Common colors
export const COMMON_PET_COLORS = [
  'Black', 'White', 'Brown', 'Gray', 'Orange', 'Cream', 'Golden',
  'Silver', 'Calico', 'Tabby', 'Spotted', 'Striped', 'Mixed'
]